...
public class ImageRegistration extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
   ...
   public static String INSERT_URL = Main_page.IP_ADDRESS + "/SetMasterImageByModel.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        INSERT_URL =Main_page.IP_ADDRESS + "/SetMasterImageByModel.php";
        UPDATE_URL= Main_page.IP_ADDRESS + "/SetMasterImageByModel.php";
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
    ...
    private void initializeSpinner() {
        ...
        ServerJson s=new ServerJson(ImageRegistration.this);
        MyDbHelper myDbHelper=new MyDbHelper(getBaseContext(),MyDbHelper.DB_NAME,null,1);
        ArrayList<String> appnames=new ArrayList<>();
//        appnames=myDbHelper.getAppNames();
//        if(appnames.size()==0) {
//            ServerJson serverJson = new ServerJson(ImageRegistration.this);
//            serverJson.getAppName(ImageRegistration.this,appnames);
//            appnames=myDbHelper.getAppNames();
//        }
        ArrayList<String> partnamelist = new ArrayList<String>();
       // for(String appn:appnames)
            partnamelist.addAll(myDbHelper.getPartnameByVarient(commonMethods.getVarient(qr.getText().toString())));
...
// xcxc
    ...
    private String getModel(){
        ...
        platform = a[1].charAt(0)+""+a[1].charAt(1)+""+a[1].charAt(2);
        platform=methods.getPlatform(qr_code);
        return platform;
    }
    ...
    public void onNothingSelected(AdapterView<?> parent) {
        //platform=parent.getSelectedItem().toString();
    }
    ...
    private void addImage(){
        ...
        if (bitmapImage != null){
            ...
            //String model_nm = qr.getText().toString().replaceAll("([0-9])", "").trim();
                  ...
                  db.addImage( part_name,platform,commonMethods.getVarient(qr_res), bitmapToByteArray(bitmapImage),"No description");
                  db.close();
    ...
    private void fetchImages(){
        ...
        Cursor c1 = db.getAllImagesOfSpecificModel(model_nm,part_name,qr_res);
        if (c1 != null && c1.getCount() != 0) {
            if (c1.moveToFirst()) {
...
// Start Volley Work
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DATA_URL,
            ...
            protected Map<String,String> getParams(){
                ...
                params.put("platform",getModel());

                params.put("varient",commonMethods.getVarient(qr_res));
                Log.e("platform: ",getModel());
                return params;
            }
                    ...
                    public void onResponse(final String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                db.addImage( part_name,model,commonMethods.getVarient(qr_res), base64ToByteArray(image),description);
                            }
                            fetchImages();
